...
namespace ProduktCyfrowy.Migrations
{
    ...
    [Migration("20240612050446_reservations_users")]
    partial class reservations_users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProduktCyfrowy.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ProduktCyfrowy.Reservation", b =>
                {
                    b.HasOne("ProduktCyfrowy.Room", "Room")
                        .WithMany("Reservations")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProduktCyfrowy.User", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("ProduktCyfrowy.User", b =>
                {
                    b.HasOne("ProduktCyfrowy.Role", "Role")
                        .WithMany()
